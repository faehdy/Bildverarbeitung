...
def segment_util(img):
    ...
    # # Apply mean shift
    # img_shifted = cv.pyrMeanShiftFiltering(img, sp=bandwidth, sr=bandwidth)

    # # Convert to grayscale
    # img_seg = cv.cvtColor(img_shifted, cv.COLOR_BGR2GRAY)
...
#     img_seg = cv.cvtColor(segmented_image, cv.COLOR_BGR2GRAY)
